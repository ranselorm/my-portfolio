...
const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-3xl flex justify-between items-center px-2 py-2 relative bg-white text-white rounded-full border-[1px] border-gray-800">
